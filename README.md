...
```bash
# 1. Clone & configure
git clone https://github.com/Denjell/TLE.git && cd TLE
./setup.sh
...
**Need to deploy on AWS?** Run `./deploy-aws.sh` — it handles everything.

**Want to customize?** Edit `config.json` to change prefix, messages, features.
